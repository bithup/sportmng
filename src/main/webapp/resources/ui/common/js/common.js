...
//上传身份证正面文件
function openImageUploadDialogIdFront(obj) {

    var src = "common/upload/imageUploadInit.htm?paraJson=" + JSON.stringify(obj);
    $.ligerDialog.open({
        name: "image_upload_DialogIdFront",
        title: "身份证正面上传窗口",
        height: 540,
        url: src,
        width: 700,
        ...
        buttons: [
            {
                text: '确定', onclick: function (item, dialog) {
                var data = $("#image_upload_DialogIdFront")[0].contentWindow.h2y_returnData();
                if (data) {
                    h2y_imageUploadCallBackIdFront(data);
                    dialog.close();
                }
            }
            },
...
//上传身份证背面文件
function openImageUploadDialogIdBack(obj) {

    var src = "common/upload/imageUploadInit.htm?paraJson=" + JSON.stringify(obj);
    $.ligerDialog.open({
        name: "image_upload_DialogIdBack",
        title: "身份证背面上传窗口",
        height: 540,
        url: src,
        width: 700,
        ...
        buttons: [
            {
                text: '确定', onclick: function (item, dialog) {
                var data = $("#image_upload_DialogIdBack")[0].contentWindow.h2y_returnData();
                if (data) {
                    h2y_imageUploadCallBackIdBack(data);
                    dialog.close();
                }
            }
            },
...
//上传身份证背面文件
function openImageUploadDialogLicense(obj) {

    var src = "common/upload/imageUploadInit.htm?paraJson=" + JSON.stringify(obj);
    $.ligerDialog.open({
        name: "image_upload_DialogLicense",
        title: "营业执照上传窗口",
        height: 540,
        url: src,
        width: 700,
        ...
        buttons: [
            {
                text: '确定', onclick: function (item, dialog) {
                var data = $("#image_upload_DialogLicense")[0].contentWindow.h2y_returnData();
                if (data) {
                    h2y_imageUploadCallBack(data);
                    dialog.close();
                }
