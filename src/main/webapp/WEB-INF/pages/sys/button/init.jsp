...
<head>
    ...
    <script type="text/javascript">
        ...
        var visibleData = [{isVisible: 1, text: '是'}, {isVisible: 0, text: '否'}];
        $(function () {
        ...
        function f_getList() {
            ...
            $("#listgrid").ligerGrid({
                columns: [
                    {display: '名称',name: 'buttonName',width: 200,maxWidth: 150,align: 'left',type: 'text',editor: {type: 'text'}},
                    {display: '点击方法', name: 'buttonClick', width: 150, maxWidth: 200, align: 'left', type: 'text', editor: {type: 'text'}},
                    {display: '图标', name: 'buttonIcon', width: 100, maxWidth: 150, align: 'left', type: 'text', editor: {type: 'text'}},
                    {display: '排序', name: 'ord', width: 100, maxWidth: 150, align: 'left', type: 'text', editor: {type: 'spinner'}},
                    {display: '显示', name: 'isVisible', width: 100, maxWidth: 150, align: 'center', type: 'text', editor: {type: 'select', data: visibleData, valueField: 'isVisible'},
