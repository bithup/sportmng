...
<form name="editform" method="post" action="" id="editform">
    <div>
        ...
        <input type="hidden" name="status" value="${sysDictDetail.status}"/>
    </div>
    ...
    <table class="h2y_dialog_table">
        ...
        <tr>
            ...
            <td class="h2y_dialog_table_edit_td">
                <input name="remark" type="text" id="remark" class="h2y_dialog_input_long"
                       value="${sysDictDetail.remark}"/>
            </td>
        </tr>
