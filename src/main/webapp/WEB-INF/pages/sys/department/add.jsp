...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //选择器
            $("#ord").ligerSpinner({type: 'int', height: 25, width: 194,value:${sysDepartment.ord}});
        });
...
<form name="editform" method="post" action="" id="editform">
    <div>
        ...
        <input type="hidden" name="nid" value="${sysDepartment.nid}"/>
        <input type="hidden" name="op" value="${op}"/>
        <input type="hidden" name="instId" value="${sysDepartment.instId}"/>
        <input type="hidden" name="instNid" value="${sysDepartment.instNid}"/>
        <input type="hidden" name="instCode" value="${sysDepartment.instCode}"/>
        <input type="hidden" name="unitId" value="${sysDepartment.unitId}"/>
        <input type="hidden" name="unitNid" value="${sysDepartment.unitNid}"/>
        <input type="hidden" name="unitCode" value="${sysDepartment.unitCode}"/>
    ...
    <table class="h2y_dialog_table" style="width: 450px;">
        ...
        <tr>
            ...
            <td class="h2y_dialog_table_edit_td">
                <input name="ord" type="text" id="ord" value="${sysDepartment.ord}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="h2y_dialog_table_edit_td">
                <input name="deptDesc" type="text" id="deptDesc" class="h2y_input_just"
