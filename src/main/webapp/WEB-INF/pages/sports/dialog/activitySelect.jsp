...
<head>
    ...
    <script type="text/javascript">
        ...
        function f_getList() {
            ...
            var url_1 = "business/activity/getList.htm?isRecommend=0&activityName="+activityName;
            $("#listgrid").ligerGrid({
                columns: [
                    {display: "活动名称", name: "activityName", width: 150, align: "left", type: "string"},
                    {display: "活动类型", name: "activityType", width: 100, align: "left", type: "string"},
                    {display: "活动地址", name: "activityAddress", width: 150, align: "left", type: "string"},
                    {display: "联系电话", name: "contactsPhone", width: 150, align: "left", type: "string"},
                    {display: "价格", name: "activityPrice", width: 150, align: "left", type: "string"}
                ],
                url: url_1,
                parms: [
                    {name: "op", value: "grid"}
        ...
        <div id="conditiondiv" style="align:center;padding-top:5px;padding-bottom:5px;">
            <table id='id-querytable' class='css-querytable'>
                <tr height='25px'>
                    ...
                    <td colspan='1' align='left'><input style='width:100px;' id='activityName' name='activityName' type='text'
                                                        value=''/></td>
