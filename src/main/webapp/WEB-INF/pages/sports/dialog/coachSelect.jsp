...
<head>
    ...
    <script type="text/javascript">
        ...
        function f_getList() {
            var name=$("#name").val();
            var url_1 = "sport/coach/getList.htm?isRecommend=0&name="+name;
            $("#listgrid").ligerGrid({
                columns: [
                    {display: "教练名称", name: "name", width: 150, align: "left", type: "string"},
                    {display: "活动类型", name: "sportsType", width: 100, align: "left", type: "string"},
                    {display: "常驻场馆", name: "venueName", width: 150, align: "left", type: "string"},
                    {display: "联系电话", name: "telPhone", width: 150, align: "left", type: "string"}
                ],
                url: url_1,
                parms: [
                    {name: "op", value: "grid"}
    ...
    <div position="center" title="">
        <div id="conditiondiv" style="align:center;padding-top:5px;padding-bottom:5px;">
            <table id='id-querytable' class='css-querytable'>
                <tr height='25px'>
                    <td align='right' width='80px'>教练名称:&nbsp;</td>
                    <td colspan='1' align='left'><input style='width:100px;' id='name' name='name' type='text'
                                                        value=''/></td>
