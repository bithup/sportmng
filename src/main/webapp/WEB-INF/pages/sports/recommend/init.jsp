...
<head>
    ...
    <script type="text/javascript">
        ...
        function getList(){
            var name = $("#name").val();
            var url_1 = "sport/childVenue/getListRecommend.htm?isRecommend=1&venueName="+name;
            $("#listgrid").ligerGrid({
                columns: [${gridComluns}],
                url: url_1,
                parms: [
        ...
        function h2y_delete(){
            ...
            $.post("sport/childVenue/update.htm?isRecommend=0&id=" + rows[0].id, function (data) {
        ...
        function openChildVenueSelectDialog() {
            var src = "sport/childVenue/getListSelect.htm";
            $.ligerDialog.open({
                name: "select_childVenue_dialog",
                title: "选择商品",
                height: 450,
                url: src,
                width: 700,
                ...
                buttons: [
                    {
                        ...
                        var data = $("#select_childVenue_dialog")[0].contentWindow.h2y_returnData();
                        if (data) {
        ...
        function h2y_ChildVenueSelectCallBack(data) {
            ...
            $.post("<%=basePath%>sport/childVenue/update.htm?isRecommend=1&id=" + childVenue.id, function (data) {
                var jsonReturn = eval("(" + data + ")");
                if (jsonReturn.code == "1") {
                    alert(jsonReturn.msg);
                    h2y_refresh()
