...
<head>
    ...
    <script type="text/javascript">
        ...
        function getList(){
            ...
            var url_1 = "/business/activity/getList.htm?isCheck=0"+"&startTime="+startTime+"&endTime="+endTime;
            $("#listgrid").ligerGrid({
                columns: [${gridComluns}],
                url: url_1,
                parms: [
        ...
        function h2y_check(){
            ...
            var src = "/business/check/activityDetail.htm?id=" + rows[0].id;
            top.f_addTab("_business_check_actiivtyDetail_htm_id_" + rows[0].id, "活动审核详情", src);
        }
