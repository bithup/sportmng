    ...
    <script type="text/javascript">
        ...
        function h2y_save() {
           ...
           // introduceEditor.sync();
            $.post("business/discuss/save.htm", queryString, function (data) {
                var jsonReturn = eval("(" + data + ")");
                if (op == "modify") {
                    if (jsonReturn.code == "1") {
                        alert(jsonReturn.msg);
                        if (top.f_getframe("business_discuss_init_htm") != null) {
                            top.f_getframe("business_discuss_init_htm").f_query();
                            top.f_delTab("business_discuss_add_htm_op_modify_id_${recommend.id}");
                        }
                    } else {
                        alert(jsonReturn.msg);
                    }
                    ...
                    if (jsonReturn.code == "1") {
                        ...
                        if (top.f_getframe("business_discuss_init_htm") != null) {
                            top.f_getframe("business_discuss_init_htm").f_query();
                            top.f_delTab("business_discuss_add_htm_op_add_id");
                        }
                    } else {
                        alert(jsonReturn.msg);
                    }
...
<form name="editform" method="post" action="" id="editform">
    ...
    <table class="h2y_table">
        ...
        <tr>
            <td class="h2y_table_label_td" colspan="3">
                回复：
            </td>
