...
<div class="">
                ...
                <form id="loginform" action="">
                    <table cellpadding="10" cellspacing="0" border="0" width="100%">
                        ...
                        <tr style="display: none;">
                            <td>行业：<select name="instId" id="_instId" class="login_inpIndustry">
                                <c:forEach var="c" items="${industryList}">
                        ...
                        <tr>
                            <td>用户：<input id="_userName" name="account" type="text" class="login_inpName"
                                          placeholder="admin@zz"/></td>
                        </tr>
                        <tr>
                            <td>密码：<input id="_password" type="password"
                                          name='password'
                                          class="login_inpLock"/></td>
                        </tr>
                        <tr>
    ...
    <div class="login_banqu"><img src="<%=uiPath%>portal/login/img/banquan.png"/></div>
</div>
